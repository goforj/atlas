	...
	return []surfaceContract{
		...
		},
		{
			...
			sources: []sourceContract{
				...
				{id: "named-queue-injection", paths: []string{"internal/invoices/report_dispatcher.go", "internal/reports/*.go"}, identifiers: []string{"Manager"}, identifierChoices: [][]string{{"ReportDispatcher", "Dispatcher"}}, declarations: []declarationContract{{nameChoices: []string{"NewReportDispatcher", "NewDispatcher"}, identifiers: []string{"Manager"}, selectorCalls: []string{"Reports"}}}},
		...
		},
		{
			...
			sources: []sourceContract{
				...
				{id: "named-cache-injection", paths: []string{"internal/invoices/profile_cache.go", "internal/profiles/*.go"}, identifiers: []string{"Manager"}, identifierChoices: [][]string{{"ProfileCache", "Cache"}}, declarations: []declarationContract{{nameChoices: []string{"NewProfileCache", "NewCache"}, identifiers: []string{"Manager"}, selectorCalls: []string{"Profiles"}}}},
		...
		},
		{
			...
			sources: []sourceContract{
				...
				{id: "named-storage-injection", paths: []string{"internal/invoices/avatar_storage.go", "internal/avatars/*.go"}, identifiers: []string{"Manager"}, identifierChoices: [][]string{{"AvatarStorage", "Storage"}}, declarations: []declarationContract{{nameChoices: []string{"NewAvatarStorage", "NewStorage"}, identifiers: []string{"Manager"}, selectorCalls: []string{"Avatars"}}}},
