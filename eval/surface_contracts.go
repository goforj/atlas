	...
	return []surfaceContract{
		...
		},
		{
			...
			sources: []sourceContract{
				...
				{id: "event-reaction", paths: []string{"internal/events/*.go", "internal/notifications/*.go", "app/lifecycle.go"}, identifiers: []string{"Subscribers", "UserCreatedHandler", "Register", "Startup", "Shutdown"}, forbiddenCalls: []string{"Background", "TODO"}, declarations: []declarationContract{{name: "Register", receiver: "Subscribers", identifiers: []string{"UserID"}, selectorCalls: []string{"Subscribe"}, selectorCallChoices: [][]string{{"Handle", "HandleUserCreated"}}}, {name: "Startup", receiver: "LifecycleRegistry", selectorCalls: []string{"Register"}}, {name: "Shutdown", receiver: "LifecycleRegistry", selectorCalls: []string{"Close"}}}},
